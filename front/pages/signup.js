...
const Signup = () =>{
    ...
    return(
        ...
        <div className={styles.title}>회원가입</div>
            ...
            <Button className={styles.signupButton} variant="outline-success" onClick={ageCheck}><SiNaver/> 네이버로 회원가입</Button><br/>
            <Button className={styles.signupButton} variant="outline-secondary" onClick={ageCheck}><AiOutlineMail/> 이메일로 회원가입</Button><br/>
                이미 계정이 있으신가요?
